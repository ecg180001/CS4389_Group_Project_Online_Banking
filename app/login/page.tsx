...
export default function Login() {
    ...
    <div className="content">
        ...
        <button onClick={() => location.href='verification.html'}>Log In</button>
        </form>
        ...
        <a href="https://www.linkedin.com/in/eminqasimov/">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <div className="content">
        ...
        <span className="loginwith">Or use email</span>
        <form onSubmit={(event) => event.preventDefault()}>
        <input type="text" placeholder="name" />
        <input type="email" placeholder="email" />
        <input type="password" placeholder="password" />
        <input type="number" placeholder="Account Number" />
        <label className="remember" for="terms">
            {" "}
            <input type="checkbox" id="terms" />
            <span>I accept terms</span>{" "}
        </label>
        <span className="clearfix"></span>
        <button onClick={()=>window.location.href='verification.html'}>Submit</button>
        </form>
                </div>
            </div>
        </div>;
